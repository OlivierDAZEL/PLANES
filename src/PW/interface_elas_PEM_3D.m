...
Mat_PW(number_of_eq,dof_medium_2(5))=-SV_2(1,5)*exp(-1j*k_z_2(5)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(6))=-SV_2(1,6)*exp(-1j*k_z_2(6)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(7))=-SV_2(1,7)*exp(-1j*k_z_2(7)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(8))=-SV_2(1,8)*exp(-1j*k_z_2(8)*multilayer(i_interface+1).d);
...
Mat_PW(number_of_eq,dof_medium_2(5))=-SV_2(2,5)*exp(-1j*k_z_2(5)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(6))=-SV_2(2,6)*exp(-1j*k_z_2(6)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(7))=-SV_2(2,7)*exp(-1j*k_z_2(7)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(8))=-SV_2(2,8)*exp(-1j*k_z_2(8)*multilayer(i_interface+1).d);
% u_z^e=u_z^s
number_of_eq=number_of_eq+1;
...
Mat_PW(number_of_eq,dof_medium_2(5))=-SV_2(3,5)*exp(-1j*k_z_2(5)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(6))=-SV_2(3,6)*exp(-1j*k_z_2(6)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(7))=-SV_2(3,7)*exp(-1j*k_z_2(7)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(8))=-SV_2(3,8)*exp(-1j*k_z_2(8)*multilayer(i_interface+1).d);
% u_z^e=u_z^t
number_of_eq=number_of_eq+1;
Mat_PW(number_of_eq,dof_medium_1(1))= SV_1(3,1)*exp(-1j*k_z_1(1)*multilayer(i_interface).d);
Mat_PW(number_of_eq,dof_medium_1(2))= SV_1(3,2)*exp(-1j*k_z_1(2)*multilayer(i_interface).d);
...
Mat_PW(number_of_eq,dof_medium_2(5))=-(SV_2(5,5)-SV_2(8,5))*exp(-1j*k_z_2(5)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(6))=-(SV_2(5,6)-SV_2(8,6))*exp(-1j*k_z_2(6)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(7))=-(SV_2(5,7)-SV_2(8,7))*exp(-1j*k_z_2(7)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(8))=-(SV_2(5,8)-SV_2(8,8))*exp(-1j*k_z_2(8)*multilayer(i_interface+1).d);

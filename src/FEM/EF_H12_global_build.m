...
% Construction des matrices ?l?mentaires pour tous les ?l?ments car
% identiques
...
[vh,vq]=H12_fluid(nodes(node_2,1)-nodes(node_1,1),nodes(node_3,2)-nodes(node_2,2));
...
size_global_matrices=3*nb_dof_node*nb.nodes;

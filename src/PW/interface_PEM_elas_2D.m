...
number_of_eq=number_of_eq+1;
Mat_PW(number_of_eq,dof_medium_1(1))=-(SV_1(4,1)-SV_1(5,1))*exp(-1j*k_z_1(1)*multilayer(i_interface).d);
Mat_PW(number_of_eq,dof_medium_1(2))=-(SV_1(4,2)-SV_1(5,2))*exp(-1j*k_z_1(2)*multilayer(i_interface).d);
Mat_PW(number_of_eq,dof_medium_1(3))=-(SV_1(4,3)-SV_1(5,3))*exp(-1j*k_z_1(3)*multilayer(i_interface).d);
Mat_PW(number_of_eq,dof_medium_1(4))=-(SV_1(4,4)-SV_1(5,4));
Mat_PW(number_of_eq,dof_medium_1(5))=-(SV_1(4,5)-SV_1(5,5));
Mat_PW(number_of_eq,dof_medium_1(6))=-(SV_1(4,6)-SV_1(5,6));
...
Mat_PW(number_of_eq,dof_medium_2(3))= SV_2(4,3)*exp(-1j*k_z_2(1)*multilayer(i_interface+1).d);
Mat_PW(number_of_eq,dof_medium_2(4))= SV_2(4,4)*exp(-1j*k_z_2(2)*multilayer(i_interface+1).d);

...
function [nb,nodes,elements,element_label,edges,num_media,element_num_mat,interfaces,edges_MMT,loads,dirichlets,periodicity]=createmshH16(lx,ly,nx,ny,tracefigure)

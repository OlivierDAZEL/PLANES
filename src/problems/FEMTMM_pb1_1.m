...
% Structure for the FEM coupling
multilayer_femtmm(1).d=delta_y_MMT/2;
multilayer_femtmm(1).mat=label_porous;
multilayer_femtmm(2).d=delta_y_MMT/2;
multilayer_femtmm(2).mat=label_porous;
% Problem for the PW resolution

...
Mat_PW(number_of_eq,dof_medium_2(4))=(SV_2(4,4)-SV_2(5,4))*exp(-1j*k_z_2(1)*multilayer(1).d);
Mat_PW(number_of_eq,dof_medium_2(5))=(SV_2(4,5)-SV_2(5,5))*exp(-1j*k_z_2(2)*multilayer(1).d);
Mat_PW(number_of_eq,dof_medium_2(6))=(SV_2(4,6)-SV_2(5,6))*exp(-1j*k_z_2(3)*multilayer(1).d);

...
for i_field=1:8
    ...
    Mat_PW(number_of_eq,dof_medium_2(5))=-SV_2(i_field,5)*exp(-1j*k_z_2(1)*multilayer(i_interface+1).d);
    Mat_PW(number_of_eq,dof_medium_2(6))=-SV_2(i_field,6)*exp(-1j*k_z_2(2)*multilayer(i_interface+1).d);
    Mat_PW(number_of_eq,dof_medium_2(7))=-SV_2(i_field,7)*exp(-1j*k_z_2(3)*multilayer(i_interface+1).d);
    Mat_PW(number_of_eq,dof_medium_2(8))=-SV_2(i_field,8)*exp(-1j*k_z_2(4)*multilayer(i_interface+1).d);

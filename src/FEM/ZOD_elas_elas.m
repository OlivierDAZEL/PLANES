...
for ii=1:size(edges.ZOD_moins,1)
    ...
    TT=build_FEM_transfer_2D(k_air*sin(data_model.multilayer_ZOD(number_ZOD).theta_ZOD),elem.ZOD_moins,elem.ZOD_plus,omega,data_model.multilayer_ZOD(number_ZOD),k_air,air);

...
for ie=1:nb_elements
    ...
    y=[coord_elem(2,:)];
    r=sqrt((x-3).^2+(y-3).^2);
    c=sqrt([Phi_elem(1,1)^2+Phi_elem(2,1)^2;Phi_elem(1,2)^2+Phi_elem(2,2)^2;Phi_elem(1,3)^2+Phi_elem(2,3)^2]);
    c_trace=(c);
...
%    colorbar
        ...
        for i_fig=1
            %subplot(2,2,i_fig)
            hold on
            plot(r,abs([Phi_elem(1,1)^2+Phi_elem(2,1)^2;Phi_elem(1,2)^2+Phi_elem(2,2)^2;Phi_elem(1,3)^2+Phi_elem(2,3)^2]),'.')
        end
%         figure(1001)
%         for i_fig=1
%             %subplot(2,2,i_fig)
